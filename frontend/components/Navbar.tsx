          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center gap-4 group">
              <div className="relative">
                <div className={`w-10 h-10 lg:w-12 lg:h-12 rounded-lg flex items-center justify-center transform group-hover:scale-105 transition-all duration-300 ${
                  isScrolled 
              ...
              <div>
                <h1 className={`text-xl lg:text-2xl font-light tracking-tight ${
                  isScrolled 
                    ? 'text-gray-900' 
                    : 'text-white'
                }`}>
                ...
                <p className={`text-xs lg:text-sm font-light tracking-wider ${
                  isScrolled 
                    ? 'text-red-600' 
                    : 'text-red-200'
                }`}>
            ...
            {/* Desktop Navigation - Clean Quanta style */}
            ...
            <div className="flex items-center gap-2 lg:gap-3">
                ...
                <div className="flex items-center">
                  {!searchFocused ? (
                    <button
                      ...
                      className={`w-9 h-9 lg:w-10 lg:h-10 rounded-lg flex items-center justify-center transition-all duration-300 ${
                        isScrolled
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`h-9 lg:h-10 w-56 lg:w-64 pl-4 pr-10 rounded-lg text-sm transition-all duration-300 focus:outline-none focus:ring-2 ${
                          isScrolled
                      ...
                      <button
                        ...
                        className={`absolute right-3 top-1/2 transform -translate-y-1/2 ${
                          isScrolled ? 'text-gray-400 hover:text-gray-600' : 'text-red-200 hover:text-white'
                        }`}
                      >
              ...
              <div className="hidden sm:flex items-center gap-1 lg:gap-2">
                <button className={`w-9 h-9 lg:w-10 lg:h-10 rounded-lg flex items-center justify-center transition-all duration-300 group ${
                  isScrolled
                    ? 'text-gray-600 hover:text-red-600 hover:bg-red-50'
                    : 'text-red-100 hover:text-white hover:bg-white/10'
                }`}>
                ...
                <button className={`w-9 h-9 lg:w-10 lg:h-10 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-105 ${
                  isScrolled
              ...
              <button
                ...
                className={`lg:hidden w-9 h-9 rounded-lg flex items-center justify-center transition-all duration-300 ${
                  isScrolled
                    ? 'text-gray-600 hover:text-red-600 hover:bg-red-50'
                    : 'text-red-100 hover:text-white hover:bg-white/10'
                }`}
